...
import WellnessProviderInfo from "./WellnessProviderInfo";
...
const Request = ({}: Props) => {
  ...
  return (
    <div className="tw-bg-white tw-p-3 tw-px-3 md:tw-px-8">
      <div className="tw-border tw-border-gray-200 tw-rounded-xl">
        ...
        {open && <WellnessProviderInfo handleOpen={handleOpen} open={open} />}
      </div>
    </div>
  );
};

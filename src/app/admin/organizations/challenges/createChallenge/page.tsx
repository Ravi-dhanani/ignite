...
import ChallangesDetail from "../components/ChallangesDetail";

type Props = {};

const CreateChallenge = (props: Props) => {
      ...
      <div className="tw-fixed tw-inset-0 tw-bg-[#F7F7F7] tw-z-50">
        <div className="  tw-h-16 tw-bg-white tw-shadow-md tw-flex tw-items-center tw-justify-between tw-py-2 tw-px-4">
          <h1 className="tw-text-xl tw-flex tw-items-center">
            <XMarkIcon
              ...
              onClick={() => router.push("/admin/organizations/challenges")}
            />
            Create Challenge
          </h1>
        ...
        <div className="tw-overflow-scroll tw-h-full tw-w-full">
          ...
          <div className="tw-p-5 tw-flex tw-justify-center">
            <div className="tw-max-w-4xl tw-w-full tw-bg-white tw-mb-8 tw-opacity-85 tw-border tw-border-blue-grey-100 tw-rounded-lg tw-p-5">
              <ChallangesDetail />
            </div>
          </div>
        </div>

...
const data = [
  {
    ...
    Qualifications: "Certified Trainer working with Microsoft",
    CoachingTrainingPreference: "Men Workout",
    Liescences: "3 licenses",
  },
  {
    Name: "Jakob Rhiel Madsen",
    Qualifications: "Certified Trainer working with Microsoft",
...
export default function LstTrainers() {
  ...
  const columns = [
    ...
    {
      accessorFn: (row: any) => row.Qualifications,
      id: "Qualifications",
      cell: (info: any) => info.getValue(),
      header: () => "Qualifications",
    },
    {
      accessorFn: (row: any) => row.CoachingTrainingPreference,
      id: "CoachingTrainingPreference",
      cell: (info: any) => info.getValue(),
      header: () => "Coaching/Training Preference",
    },
    {
      accessorFn: (row: any) => row.Liescences,
      id: "Liescences",
      cell: (info: any) => info.getValue(),
      header: () => "Liescences",
    },
  ...
  return (
    <div className="tw-p-0">
      ...
      {open && <EditTrainer handleOpen={handleOpen} open={open} />}
    </div>
  );
}

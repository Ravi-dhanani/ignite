...
export function Topbar() {
  ...
  return (
    <Navbar className="tw-fixed tw-top-0 !tw-px-4 md:!tw-px-6 tw-z-30 !tw-py-0 !tw-max-w-full !tw-rounded-none">
      <div className="tw-flex tw-items-center tw-justify-between tw-text-blue-gray-900 tw-w-full">
        <div className="tw-flex tw-items-center">
          <Typography
            as="a"
            href="#"
            variant="h6"
            className="tw-mr-8 tw-cursor-pointer tw-py-1.5"
          >
              ...
              <Menu>
                <MenuHandler>
                  <Button
                    variant="outlined"
                    color="blue-gray"
                    className="tw-flex tw-items-center tw-gap-3 tw-capitalize !tw-text-sm tw-to-blue-gray-900"
                  >
              ...
              <MenuHandler>
                <div className="tw-flex tw-items-center tw-cursor-pointer">
                  <Avatar
                    variant="circular"
                    alt="tania andrew"
                    className=" tw-h-10 tw-w-10 tw-rounded-full tw-mr-2"
